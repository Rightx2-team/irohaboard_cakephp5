	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<tr>
				...
				<th>メールアドレス</th>
				<th>備考</th>
				<th>所属グループ・・・<?= \Cake\Core\Configure::read('import_group_count');?>列</th>
				<th>受講コース・・・<?= \Cake\Core\Configure::read('import_course_count');?>列</th>
			</tr>
			</table>
			<?php
				// PHP8.1対応
				...
				echo $this->Form->submit('インポート', \Cake\Core\Configure::read('form_submit_defaults'));
				echo $this->Form->end();
			?>
			<div style="color:red;">
			<?= $err_msg; ?>
