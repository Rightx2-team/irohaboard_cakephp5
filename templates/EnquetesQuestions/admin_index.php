...
<div class="admin-contents-questions-index">
	...
	<div class="buttons_container">
		<button type="button" class="btn btn-primary btn-add" onclick="location.href='<?= $this->Url->build(['action' => 'add', $content['Content']['id']]) ?>'">+ 追加</button>
	</div>
	...
	<tr>
		...
		<td><?php echo h(\Cake\Core\Configure::read('question_type.'.$contentsQuestion['ContentsQuestion']['question_type'])); ?>&nbsp;</td>
		...
		<td class="actions text-center">
			<button type="button" class="btn btn-success" onclick="location.href='<?= $this->Url->build(['action' => 'edit', $contentsQuestion['Content']['id'], $contentsQuestion['ContentsQuestion']['id']]) ?>'">編集</button>
